...
namespace CarWashProcessor.UnitTests.Application.Strategies.Addon
{
    ...
    public class TireShineServiceTests
    {
        ...
        private TireShineService? _addonService = null;
        ...
        {
            var exception = Assert.ThrowsException<ArgumentNullException>(() => _addonService = new TireShineService(null!));
        ...
        {
            _addonService = new TireShineService(_loggerMock!.Object);
